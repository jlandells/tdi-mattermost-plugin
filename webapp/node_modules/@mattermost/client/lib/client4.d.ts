...
import type { ClientConfig, ClientLicense, DataRetentionPolicy, License, AdminConfig, EnvironmentConfig, RequestLicenseBody, AllowedIPRanges, AllowedIPRange, FetchIPResponse, LdapSettings } from '@mattermost/types/config';
...
import type { Group, GroupPatch, GroupSyncable, MixedUnlinkedGroup, SyncablePatch, UsersWithGroupsAndCount, GroupsWithCount, GroupCreateWithUserIds, GroupSearchParams, CustomGroupPatch, GetGroupsParams, GetGroupsForUserParams, GroupStats, GroupMember } from '@mattermost/types/groups';
...
export declare enum LdapDiagnosticTestType {
    FILTERS = "filters",
...
export default class Client4 {
    ...
    getProfilesNotInChannel: (teamId: string, channelId: string, groupConstrained: boolean, page?: number, perPage?: number, cursorId?: string) => Promise<UserProfile[]>;
    ...
    canUserDirectMessage: (userId: string, otherUserId: string) => Promise<{
        can_dm: boolean;
    }>;
    ...
    getAllChannels(page: number | undefined, perPage: number | undefined, notAssociatedToGroup: string | undefined, excludeDefaultChannels: boolean | undefined, includeTotalCount: false | undefined, includeDeleted: boolean | undefined, excludePolicyConstrained: boolean | undefined, accessControlPolicyEnforced: boolean | undefined, excludeAccessControlPolicyEnforced: boolean | undefined): Promise<ChannelWithTeamData[]>;
    getAllChannels(page: number | undefined, perPage: number | undefined, notAssociatedToGroup: string | undefined, excludeDefaultChannels: boolean | undefined, includeTotalCount: true, includeDeleted: boolean | undefined, excludePolicyConstrained: boolean | undefined, accessControlPolicyEnforced: boolean | undefined, excludeAccessControlPolicyEnforced: boolean | undefined): Promise<ChannelsWithTotalCount>;
    ...
    getSharedChannelRemoteInfos: (channelId: string) => Promise<RemoteClusterInfo[]>;
    getRemoteClusterInfo: (remoteId: string) => Promise<RemoteClusterInfo>;
    ...
    updateCustomProfileAttributeValues: (attributeValues: Record<string, string | string[]>) => Promise<Record<string, string | string[]>>;
    ...
    isAllowedToUpgradeToEnterprise: () => Promise<StatusOK>;
    ...
    testLdapConnection: (settings: LdapSettings) => Promise<StatusOK>;
    testLdapDiagnostics: (settings: LdapSettings, testType: LdapDiagnosticTestType) => Promise<StatusOK>;
    testLdapFilters: (settings: LdapSettings) => Promise<StatusOK>;
    testLdapAttributes: (settings: LdapSettings) => Promise<StatusOK>;
    testLdapGroupAttributes: (settings: LdapSettings) => Promise<StatusOK>;
    ...
    uploadAuditLogCertificate: (fileData: File) => Promise<StatusOK>;
    removeAuditLogCertificate: () => Promise<StatusOK>;
    ...
    addUsersToGroup: (groupId: string, userIds: string[]) => Promise<GroupMember[]>;
    removeUsersFromGroup: (groupId: string, userIds: string[]) => Promise<GroupMember[]>;
    ...
    getAccessControlPolicy: (id: string) => Promise<AccessControlPolicy>;
    updateOrCreateAccessControlPolicy: (policy: AccessControlPolicy) => Promise<AccessControlPolicy>;
    deleteAccessControlPolicy: (id: string) => Promise<AccessControlPolicy>;
    getAccessControlPolicies: (after: string, limit: number) => Promise<AccessControlPoliciesResult>;
    getChildPolicies: (parentId: string, after: string, limit: number) => Promise<AccessControlPoliciesResult>;
    getChannelsForAccessControlPolicy: (policyId: string, after: string, limit: number) => Promise<AccessControlPolicyChannelsResult>;
    searchAccessControlPolicies: (term: string, type: string, after: string, limit: number) => Promise<AccessControlPoliciesResult>;
    searchChildAccessControlPolicyChannels: (policyId: string, term: string, opts: ChannelSearchOpts) => Promise<ChannelsWithTotalCount>;
    updateAccessControlPolicyActive: (policyId: string, active: boolean) => Promise<StatusOK>;
    assignChannelsToAccessControlPolicy: (policyId: string, channelIds: string[]) => Promise<StatusOK>;
    unassignChannelsFromAccessControlPolicy: (policyId: string, channelIds: string[]) => Promise<StatusOK>;
    getAccessControlFields: (after: string, limit: number) => Promise<UserPropertyField[]>;
    checkAccessControlExpression: (expression: string) => Promise<CELExpressionError[]>;
    testAccessControlExpression: (expression: string, term: string, after: string, limit: number) => Promise<AccessControlTestResult>;
    expressionToVisualFormat: (expression: string) => Promise<AccessControlVisualAST>;
    getChannelAccessControlAttributes: (channelId: string) => Promise<AccessControlAttributes>;
}
