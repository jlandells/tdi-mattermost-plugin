...
function teams(state = {}, action) {
    switch (action.type) {
        ...
        case action_types_1.AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY_TEAMS_SEARCH:
            return Object.assign({}, state, (0, team_utils_1.teamListToMap)(action.data));
        ...
        case action_types_1.UserTypes.LOGIN: // Used by the mobile app
            return Object.assign({}, state, (0, team_utils_1.teamListToMap)(action.data.teams));
        ...
        case action_types_1.TeamTypes.RECEIVED_TEAM_UNARCHIVED: {
        ...
        case action_types_1.AdminTypes.REMOVE_DATA_RETENTION_CUSTOM_POLICY_TEAMS_SUCCESS: {
...
function myMembers(state = {}, action) {
    ...
    switch (action.type) {
        ...
        case action_types_1.TeamTypes.RECEIVED_TEAMS_LIST: {
            const nextState = { ...state };
            const receivedTeams = (0, team_utils_1.teamListToMap)(action.data);
        ...
        case action_types_1.UserTypes.LOGIN: { // Used by the mobile app
            ...
            for (const m of teamMembers) {
                if (m.delete_at == null || m.delete_at === 0) {
                    const unread = teamUnreads.find((u) => u.team_id === m.team_id);
                    if (unread) {
