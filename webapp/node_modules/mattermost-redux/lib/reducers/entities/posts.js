...
function messagesHistory(state = {
    messages: [],
    index: {
        post: -1,
        comment: -1,
...
exports.zeroStateLimitedViews = {
    threads: {},
    channels: {},
};
function limitedViews(state = exports.zeroStateLimitedViews, action) {
    switch (action.type) {
        case action_types_1.PostTypes.RECEIVED_POSTS:
        case action_types_1.PostTypes.RECEIVED_POSTS_AFTER:
        case action_types_1.PostTypes.RECEIVED_POSTS_BEFORE:
        ...
        case action_types_1.CloudTypes.RECEIVED_CLOUD_LIMITS: {
            ...
            if (!limits?.messages || (!limits?.messages?.history && limits?.messages?.history !== 0)) {
                return exports.zeroStateLimitedViews;
            }
            return state;
        }
        case action_types_1.ChannelTypes.RECEIVED_CHANNEL_DELETED:
